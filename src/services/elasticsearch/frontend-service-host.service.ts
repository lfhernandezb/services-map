...
import { Query } from "../../models/fehost/request/query";
import { Request } from "../../models/fehost/request/request";
...
import { Response } from "../../models/fehost/response/response";
import { customSerializer } from "../../libs/customSerializer";

async function FrontendServiceHost(): Promise<Response> {
